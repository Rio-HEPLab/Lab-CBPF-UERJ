...
#define DEF_NUM_EVENTS					2500						/*!< Default number of events */
#define DEF_BASE_ADDRESS				0xEE00						/*!< Default boards' base address */
#define DEF_BOARD_TYPE_STR				"V1290A"					/*!< Default V1190's type string */
#define DEF_V1190_TYPE					CVT_V1290_TYPE_A				/*!< Default V1190's type */
#define DEF_TDC_COUNT					CVT_V1290_NUM_TDC_A				/*!< Default V1190 number of TDCs */
...
//#define DEF_ACQUISITION_MODE_PARAMS			"0,1,0,120,-80,1,1,2,0,0xffff,0xffff,0xffff"
#define DEF_ACQUISITION_MODE_PARAMS			"0,1,0,120,-80,1,1,2,0,0xffff"
...
/**************************************************
**************************************************/
BOOL user_settings_TDC_open( user_setting_data_TDC* p_data)
{
...
/**************************************************
**************************************************/
BOOL user_settings_TDC_close( user_setting_data_TDC* p_data)
{
...
/**************************************************
**************************************************/
BOOL user_settings_TDC_parse_input_param( user_setting_data_TDC* p_data, int argc, char* argv[])
{
	BOOL ret_val= TRUE;
